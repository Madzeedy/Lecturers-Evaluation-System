        ...
        <section class="col-lg-12">
          ...
          <div class="box box-info">
            <div class="box-header">
              ...
              <h3 class="box-title"> Lock exam</h3>
		

            </div>
            <div class="box-body">
		
              <form action="unlock_exam.php" method="post">
                <div class="col-lg-6">
                  <div class="form-group">
                    <label>Date</label><?php $today = date("Y-m-d"); ?>
                  <input type="date" min='<?php echo $today; ?>' class="form-control" name="dateending" required>
                ...
                <div class="col-lg-6">
                  <div class="form-group">
                    ...
                    <label>Time</label>
                  <input type="time" class="form-control"  name="timeending"  required>
            ...
            <div class="box-footer clearfix">
              <button type="submit" class="pull-right btn btn-success" name="newstd" id="sendEmail">Lock exam
