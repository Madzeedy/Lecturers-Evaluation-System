...
if (isset($_SESSION['examstarted']) && $_SESSION['examstarted'] == true) {
  ...
  $sql = "UPDATE results_info SET score='$av_score', status='$pass_status' WHERE  evaluation_id='$evaluation_id'";
...
?>
        ...
        <script type="text/javascript">
          alert('Thanks for taking your time to fill out this evaluation..!');
            // alert('You have got <?php echo $av_score; ?>%');
